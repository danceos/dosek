 ...
 */
final public class MT_U16 extends MT {
	 ...
	 *
	 * @param i position of the bit to be set (0-15)
	 */
	 ...
	 *
	 * @param i position of the bit to be cleared (0-15)
	 */
	 ...
	 *
	 * @param i position of the bit to be checked (0-15)
	 ...
	 */
	public boolean equals(Object o) { return (self.hashCode()==((MT_U16)o).hashCode()); }

	/** {@inheritDoc} */
	public int hashCode() { return self.hashCode(); }

	public String toString() { return "U16: "+self.get(); }
}
