...
#include "keso_parity.h"
	...
	#define CHK_IFACE_ID36(_obj_) \
		keso_checkiface((object_pointer) (NATIVE_ADDR(_obj_)), KESO_INTERFACE_IDENTIFIER(0))
	#define INSTANCEOF_IFACE_ID36(_obj_) \
		keso_instanceof_iface((object_pointer) (NATIVE_ADDR(_obj_)), KESO_INTERFACE_IDENTIFIER(0))
#else /* defined(KESO_USE_CODED_REFS) */
	#define CHK_IFACE_ID36(_obj_) \
		keso_checkiface(_obj_, KESO_INTERFACE_IDENTIFIER(0))
...
#include "keso_parity.h"
	...
	#define CHK_IFACE_ID37(_obj_) \
		keso_checkiface((object_pointer) (NATIVE_ADDR(_obj_)), KESO_INTERFACE_IDENTIFIER(0))
	#define INSTANCEOF_IFACE_ID37(_obj_) \
		keso_instanceof_iface((object_pointer) (NATIVE_ADDR(_obj_)), KESO_INTERFACE_IDENTIFIER(0))
#else /* defined(KESO_USE_CODED_REFS) */
	#define CHK_IFACE_ID37(_obj_) \
		keso_checkiface(_obj_, KESO_INTERFACE_IDENTIFIER(0))
...
#include "keso_parity.h"
	...
	#define CHK_IFACE_ID35(_obj_) \
		keso_checkiface((object_pointer) (NATIVE_ADDR(_obj_)), KESO_INTERFACE_IDENTIFIER(1))
	#define INSTANCEOF_IFACE_ID35(_obj_) \
		keso_instanceof_iface((object_pointer) (NATIVE_ADDR(_obj_)), KESO_INTERFACE_IDENTIFIER(1))
#else /* defined(KESO_USE_CODED_REFS) */
	#define CHK_IFACE_ID35(_obj_) \
		keso_checkiface(_obj_, KESO_INTERFACE_IDENTIFIER(1))
	#define INSTANCEOF_IFACE_ID35(_obj_) \
		keso_instanceof_iface(_obj_, KESO_INTERFACE_IDENTIFIER(1))
#endif /* defined(KESO_USE_CODED_REFS) */
#endif
