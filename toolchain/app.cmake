...
MACRO(COREDOS_BINARY)
  ...
  set(multiValuedParameters SOURCES LIBS)
  ...
  COREDOS_BINARY_EXECUTABLE(${NAME} "${COREDOS_BINARY_SOURCES}" ${COREDOS_SYSTEM_XML} ${COREDOS_VERIFY_SCRIPT} "" "${COREDOS_BINARY_LIBS}")

  if(${COREDOS_BINARY_FAIL} STREQUAL "TRUE")
    COREDOS_BINARY_EXECUTABLE(fail-${NAME} "${COREDOS_BINARY_SOURCES}" ${COREDOS_SYSTEM_XML} ${COREDOS_VERIFY_SCRIPT} "FAIL=1" "${COREDOS_BINARY_LIBS}")
